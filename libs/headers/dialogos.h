...
void erro_ao_inicializar_pokemon(char *nome, char *evs, char *ivs, char *moves);
...
void gerar_log_pos_batalha(Player *player1, Player *player2);
void gerar_log_vencedor_batalha(Player *player1, char *arq); // see Pattern 3 conflict below
...
void cause_bind(Pokemon *poke);
void trocar_quebra_de_linha_por_terminador(char *nome);
